...
def calculate_demographic_data(print_data=True):
   ...
   # What percentage of the people who work the minimum number of hours per week have a salary of >50K?
    ...
    jumlah_negara = df['native-country'].value_counts()
    jumlah_negara_kaya = df[a1]['native-country'].value_counts()

    highest_earning_country = ((jumlah_negara_kaya/ jumlah_negara * 100).sort_values(ascending=False)).index[0]
    highest_earning_country_percentage = round((jumlah_negara_kaya/ jumlah_negara * 100).max(),1)


    # Identify the most popular occupation for those who earn >50K in India.
    top_IN_occupation = df[(df['native-country']=='India')&a1] ['occupation'].value_counts().index[0]
